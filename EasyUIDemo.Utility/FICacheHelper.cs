...
namespace EasyUIDemo.Utility
{
    public class FICacheHelper
    {
        ...
        public static void SetCache(string cacheKey, object objObject, string fileName = null, int timeOutHours = 24)
        {
            Cache objCache = HttpRuntime.Cache;
            CacheDependency cacheDependency = fileName.IsNullOrEmpty() ? null : new CacheDependency(fileName);
